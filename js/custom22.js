...
$(function () {
	...
	$("#arabic").click(function () {
		...
		$('#our-address').text('عنواننا');
			...
			// add the ids
			$("#home ,#about ,#auction ,#log-in ,#langu ,#arabic ,#english").addClass("font1");
		}
			...
			// end log in
			// add the ids
			$("#home ,#about ,#auction ,#log-in ,#langu ,#arabic ,#english").removeClass("font1");
			$("#home ,#about ,#auction ,#log-in ,#langu ,#arabic ,#english").addClass("font2");
		}
	})
